...
def main():
    ...
    for arch in ['resnet50', 'densenet121']:
        ...
        if arch == 'resnet50':
            model.load_state_dict(torch.load('./checkpoints/resnet_test_base.pth')['state_dict'])
        else:
            model.load_state_dict(torch.load('./checkpoints/densenet_test_base.pth')['state_dict'])
